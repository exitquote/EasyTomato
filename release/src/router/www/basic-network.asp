...
//		if(wl_ifaces[uidx][0].indexOf('.') < 0) {
       ...
       if (E('_f_familyshield_enable').checked) {
               vis._f_dns_1 = 0;
               vis._f_dns_2 = 0;
               vis._f_dns_3 = 0;
        }
...
/* VLAN-END */
	...
	fom.pptp_dhcp.value = fom.f_pptp_dhcp.checked ? 1 : 0;
       ...
       if (E('_f_familyshield_enable').checked) {
         fom.wan_dns.value = joinAddr(['208.67.222.123', '208.67.220.123', '0.0.0.0']);
         nvram.familyshield = 1;
       } else {
